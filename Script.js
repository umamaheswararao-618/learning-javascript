...
//    }
 let val="uma maheswara rao";
   const myFun123 = () =>{
    let heading=document.getElementById("first1");
   
    let past=heading.textContent;
   ...
   const myFun1 = () =>{
    ...
    let past=heading.style.color;
    heading.style.color=col;
    col=past;
    
   };
   let   sr="https://i.pinimg.com/736x/25/3e/17/253e17972423290dcf626ae3a39e3194.jpg";
   const imchange= () =>{
